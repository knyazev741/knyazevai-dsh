...
/** @deprecated Reasoning defaults are model-specific; no provider-wide value is applied. */
export const DEFAULT_REASONING = undefined;
...
/** GLM uses the OpenAI-style reasoning_effort field rather than enable_thinking. */
export const GLM_REASONING_EFFORTS = Object.freeze({
  low: "low",
  high: "high",
  max: "max",
});
